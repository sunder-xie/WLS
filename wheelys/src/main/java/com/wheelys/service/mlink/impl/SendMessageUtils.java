...
public abstract class SendMessageUtils {
    ...
    public static ResultCode sendMessage(SMSRecord sms, String spid, String sppassword){
    	String content = sms.getContent();
    	String mobile = sms.getContact();
        ...
        smsParams.put("spid", spid);
        smsParams.put("sppassword", sppassword);
